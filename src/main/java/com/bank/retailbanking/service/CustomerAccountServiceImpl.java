	...
	public Optional<CustomerResponseDto> createCustomerAccount(CustomerRequestDto customerRequestDto)
		...
		if (customer.isPresent()) {
			...
			simple.setSubject(ApplicationConstants.MORTGAGE_GMAIL_SUBJECT);
			  ...
			  simple.setText(ApplicationConstants.MORTGAGE_TEXT_ONE +
			  ApplicationConstants.NEXT_LINE + ApplicationConstants.MORTGAGE_TEXT_TWO +
			  ApplicationConstants.WHITE_SPACE + "-------------------" +
			  ApplicationConstants.NEXT_LINE + ApplicationConstants.MORTGAGE_TEXT_THREE +
			  customerAccountDetail.getCustomerId().getCustomerId()+
			  ApplicationConstants.NEXT_LINE + ApplicationConstants.MORTGAGE_TEXT_FOUR +
			  ApplicationConstants.WHITE_SPACE + password +
			  ApplicationConstants.WHITE_SPACE + ApplicationConstants.NEXT_LINE +
			  ApplicationConstants.MORTGAGE_TEXT_FIVE); javaMailSender.send(simple);
