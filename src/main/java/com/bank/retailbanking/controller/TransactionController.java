...
/**
 * This class is used to perform customer transaction related operations.
 **/
...
public class TransactionController {
	...
	public ResponseEntity<Optional<FundTransferResponseDto>> fundTransfer(
		...
		fundTransferResponse.setStatusCode(404);
		fundTransferResponse.setMessage("error");
		return new ResponseEntity<>(Optional.of(fundTransferResponse), HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<MortgageAccountSummaryResponsedto> getAccountSummaryMortgage(@PathVariable Long customerId)
		...
		MortgageAccountSummaryResponsedto mortgageAccountSummaryResponsedto = transactionService
	 ...
	 * @throws GeneralException this method is used to Get transaction summary of a
	 *                          particular customer
	 */
	@GetMapping("/{customerId}")
	public ResponseEntity<TransactionResponsedto> getTransactionSummary(@PathVariable Long customerId)
			throws GeneralException {
		log.info("Entering into getAccountSummary method of LoginController");
		TransactionResponsedto transactionSummary = transactionService.getTransactionSummary(customerId);
		transactionSummary.setMessage(ApplicationConstants.SUCCESS);
		transactionSummary.setStatusCode(HttpStatus.OK.value());
